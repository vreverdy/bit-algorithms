...
TEMPLATE_PRODUCT_TEST_CASE("Shift: left_shift- single word", 
    ...
    bit::shift_left(bfirst1_t, blast1_t, 1);
    bit::word_shift_left(bool_first1_t, bool_last1_t, 1);
    REQUIRE(std::equal(bool_first1, bool_last1, bfirst1, blast1, comparator));
    ...
    bit::shift_left(bfirst1_t, blast1_t, digits-6);
    bit::word_shift_left(bool_first1_t, bool_last1_t, digits-6);
    REQUIRE(std::equal(bool_first1, bool_last1, bfirst1, blast1, comparator));
}
...
TEMPLATE_PRODUCT_TEST_CASE("Shift: right_shift- single word", 
    ...
    std::advance(bfirst1_t, 1);
    std::advance(blast1_t, digits-1);
    bit::shift_right(bfirst1_t, blast1_t, 3);
    bit::word_shift_right(bool_first1_t, bool_last1_t, 3);
    REQUIRE(std::equal(bool_first1, bool_last1, bfirst1, blast1, comparator));
    ...
    std::advance(bfirst1_t, digits+3);
    std::advance(blast1_t, 2*digits-3);
    bit::shift_right(bfirst1_t, blast1_t, 1);
    bit::word_shift_right(bool_first1_t, bool_last1_t, 1);
    REQUIRE(std::equal(bool_first1, bool_last1, bfirst1, blast1, comparator));
    ...
    std::advance(bfirst1_t, 2*digits+3);
    std::advance(blast1_t, 3*digits-3);
    bit::shift_right(bfirst1_t, blast1_t, digits-6);
    bit::word_shift_right(bool_first1_t, bool_last1_t, digits-6);
    REQUIRE(std::equal(bool_first1, bool_last1, bfirst1, blast1, comparator));
}
// -------------------------------------------------------------------------- //
